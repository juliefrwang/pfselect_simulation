...
sub_dir <- glue("simulation_res/seed_{seed}_b_{b}_rep_{num_replicate}_true_{num_true}_hete_{num_affected}_include_rare_no_snp_cluster_no_standaardize_w_AMR_sample_size_control")
