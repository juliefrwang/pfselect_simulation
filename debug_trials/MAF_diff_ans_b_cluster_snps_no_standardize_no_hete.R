...
sub_dir <- glue("simulation_res/seed_{seed}_b_{b}_rep_{num_replicate}_pcs_filter_MAF_diff_ans_b_clust_snps_FDR_{FDR_rate}_no_standardization_40_true_no_hete")
