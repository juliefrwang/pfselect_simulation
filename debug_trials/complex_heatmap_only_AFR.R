...
layout <- c(
  ...
  area(2, 1), area(2, 2), 
  area(3, 1), area(3, 2), 
  area(4, 1, 4,2) # guide_area spans two columns
)

combined_plot_2 <- mean.w.plot.1  + mean.w.plot.3 +
  mean.selection.plot.1  + mean.selection.plot.3 +
  ancestry_plot.1 + ancestry_plot.3  +
