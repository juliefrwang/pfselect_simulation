...
sub_dir <- glue("simulation_res/seed_{seed}_b_{b}_rep_{num_replicate}_true_{num_true}_hete_{num_affected}_pcs_filter_MAF_diff_ans_b_clust_snps_FDR_{FDR_rate}")
